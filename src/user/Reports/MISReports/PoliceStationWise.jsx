  ...
  return (
    <div className="container">
      <div className="card m-3 shadow">
        <Heading title="POLICE STATION WISE REPORTS 243" />
...
onMouseLeave={() => setIsHovered(false)} >  Generate  &nbsp;<FontAwesomeIcon icon={faCog}className={isHovered ? 'facoghover' : ''}/></Button>
            </div>
          </div>
        </div>
      </div>
