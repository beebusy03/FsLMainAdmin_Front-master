...
import { faChevronCircleLeft, faDeleteLeft, faTrash } from '@fortawesome/free-solid-svg-icons';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import CancelRegistrationDialog from './InnerComps/CancelRegistrationDialog';
  ...
  return (
    <>
      ...
      <Card className='m-3 shadow'>
        <Heading title="DELETE REGISTRATION" />
        <CardContent>
...
onMouseLeave={() => setIsHovered1(false)} onClick={handleModel}>
              Deleteon &nbsp; <FontAwesomeIcon icon={faTrash} className={isHovered1 ? 'fatimeshover' : ''}/>
            </Button>
