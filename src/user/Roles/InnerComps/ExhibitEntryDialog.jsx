...
const ExhibitEntryDialog = ({ isOpen, onClose, setedituse }) => {
  ...
  return (
    <React.Fragment>
      ...
      >
        <Heading title="RETURN OF EXHIBIT" />
        <DialogContent>
          <DialogContentText>
            <CardContent>
...
export default ExhibitEntryDialog;
