...
const CancelRegistrationDialog = ({ isOpen, onClose, setedituse }) => {
              ...
              <div className="row" style={{ rowGap: "7px" }}>
                ...
                <div className="row mt-3">
                  <div className="text-center">
                    ...
                    >
                      Delete &nbsp;<FontAwesomeIcon icon={faTrash} className={isHovered ? 'fatimeshover' : ''}/>
                    </Button>
                    <Button
                      variant="contained"
                      style={{ margin: "0 8px" }}
                    ...
                    >
                     Close &nbsp; <FontAwesomeIcon icon={faClose} className={isHovered2 ? 'fatimeshover' : ''}/>
                    </Button>
                  </div>
